...
Mat4 Mat4::ortho(float left, float right, float top, float bottom, float z_near, float z_far)
{
	Mat4 res;
...
Mat4 Mat4::perspective(float fov, float ar, float z_near, float z_far)
{
	Mat4 res;
...
const Mat4 Mat4::operator*(const Mat4& mat2) const
{
	Mat4 res;
...
const Vec3 Mat4::operator*(const Vec3& vec) const
{
