...
static tek::TekRect g_target_rect;
static tek::TekFramebuffer g_fb;
static Mat4 g_ortho;
...
static tek::TekRect get_target_rect(u32 win_width, u32 win_height, u32 render_width, u32 render_height)
{
    tek::TekRect result;
...
{	
    ...
    tek::tek_renderer_bind_framebuffer(&g_fb, tek::TekColor::black());

    tek_game_render();

    tek::tek_renderer_unbind_framebuffer();
    tek::tek_renderer_viewport(g_width, g_height);
    tek::tek_fb_bind_reading(&g_fb,0);
    tek::tek_renderer_render_sprite(g_target_rect, tek::TekRect(0, 0, 1, 1), g_fb.tex_id,&g_ortho );
}
