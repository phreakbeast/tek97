...
TekCamera::TekCamera(Type type, Mat4 projection)
{
    ...
    {
        case Type::First:{
            this->position = vec3_create(0, 0, 0);
            this->rotation = vec3_create(0, 0, 0);
        }break;
        case Type::Third:{
            this->position = vec3_create(0, 0, 0);
            this->rotation = vec3_create(40, 0, 0);
            this->target_position = vec3_create(0, 0, 0);
            this->target_rotation = vec3_create(0, 0, 0);
            this->distance = 10;
            this->min_distance = 2;
